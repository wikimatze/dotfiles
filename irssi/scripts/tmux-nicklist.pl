...
if ($#ARGV == -1) {
  ...
  sub term_row_count {
    # from
    # http://stackoverflow.com/questions/4286158/how-do-i-get-width-and-height-of-my-terminal-with-ioctl
    my $terminal_size;
  ...
  # open named pipe and setup
  # the 'select' wrapper object
  # for listening on both
  # fds(fifo and sdtin)
  open (FIFO, "< $fifo_path") or die "can't open $fifo_path: $!";
  my $fifo = \*FIFO;
  my $stdin = \*STDIN;
